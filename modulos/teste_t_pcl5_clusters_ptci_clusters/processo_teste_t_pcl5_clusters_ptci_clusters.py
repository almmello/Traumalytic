...
from modulos.teste_t_pcl5_clusters_ptci_clusters.calculo_teste_t_pcl5_clusters_ptci_clusters import (
    criar_teste_t_pcl5_clusters_ptci_clusters
)
...
def processar_teste_t_pcl5_clusters_ptci_clusters():
    ...
    fig, resultados = criar_teste_t_pcl5_clusters_ptci_clusters(st.session_state['data'])
    st.pyplot(fig)
