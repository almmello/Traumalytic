...
from modulos.corr_spearman_pcl5_clusters_ptci_clusters.calculo_corr_spearman_pcl5_clusters_ptci_clusters import (
    criar_corr_spearman_pcl5_clusters_ptci_clusters
)
...
def processar_corr_spearman_pcl5_clusters_ptci_clusters():
    ...
    fig = criar_corr_spearman_pcl5_clusters_ptci_clusters(st.session_state['data'])
    st.pyplot(fig)
