...
def criar_corr_pearson_pcl5_total_ptci_total(data):
    ...
    correlacao, p_value = stats.pearsonr(data_correlacao['PCL5_Total'], data_correlacao['PTCI_Total'])
    ...
    ax.set_title('Mapa de Calor de Correlação entre PCL5 Total e PTCI Total')
