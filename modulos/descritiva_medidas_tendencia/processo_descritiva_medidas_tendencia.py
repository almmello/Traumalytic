...
from modulos.descritiva_medidas_tendencia.calculo_descritiva_medidas_tendencia import (
    calcular_descritiva_medidas_tendencia
)
...
def processar_descritiva_medidas_tendencia():
    APP_USER = os.getenv("ENV_USER")
    analysis_id = 'descritiva_medidas_tendencia'
    nome_analise = 'Análise Medidas de Tendência Central'
    instrucoes = "Analisando os resultados da Análise Medidas de Tendência Central, forneça uma conclusão detalhada e útil sobre as implicações desses dados."
    ...
    for coluna in colunas_numericas:
        resultados = calcular_descritiva_medidas_tendencia(st.session_state['data'], coluna)
